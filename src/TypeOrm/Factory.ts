...
import { Project,Class,Export,Import,Method,Parameter,Module,Name,Interface,InterfaceMethod } from
...
function myCreateConnection(): Promise<Connection> {
   return createConnection({
      ...
      }, entities: [Project, Class, Export, Import, Method, Parameter, Module, Name, Interface,InterfaceMethod]
   });
}
